...
/* Copied and modified from lib/src/uart.c */

#include "baremetal/common.h"
#include "baremetal/interrupt.h"
#include "baremetal/uart.h"
#include "core_rv32_clic.h" /* For NVIC CLIC Wrapper API */
...
void rtx_uart_init(bm_uart_t *uart, const bm_uart_config_t *config)
{
    ...
    if (uart->use_irq)
    {
        ...
        NVIC_EnableIRQ(UART_CLIC_IRQ_ID);
    }
    else
    {
        NVIC_DisableIRQ(UART_CLIC_IRQ_ID);
        uart->regs->IER = 0;
    }
}
